...
class TestWeatherAPIClient(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Coordenadas de prueba (Culiacán, México)
        self.lat = 24.8087
        self.lon = -107.3940
...
class TestWeatherDataProcessor(unittest.TestCase):
    ...
    def setUp(self):
        # Cargar el scaler para el procesador
        scaler_path = './scaler_lstm.pkl'
        if not os.path.exists(scaler_path):
            scaler_path = '../../scaler_lstm.pkl'
            
        # Intentar inicializar con scaler o sin él
        try:
            self.predictor = RainfallPredictor('./modelo_lluvia_lstm.h5', scaler_path)
...
class TestRainfallPredictor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.predictor = RainfallPredictor(modelo_path, scaler_path)
    ...
    def test_predecir(self):
        ...
        sample_data = np.random.random((1, 1, 5))
...
def run_tests():
    ...
    # Crear suite de pruebas para cada componente
    suites = []
